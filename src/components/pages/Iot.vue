    ...
    <div :class="['content', showIotHelp ? '' : 'is-hidden' ]">
        ...
        <ul class="steps has-content-centered">
            ...
            <li class="steps-segment">
                ...
                <div class="steps-content">
                    <p class="is-size-5">Paralisia e indução</p>
                    <p>Aplicação do sedativo e bloqueador neuromuscular. PASSO IRREVERSÍVEL!</p>
                </div>
            </li>
            <li class="steps-segment">
            ...
            <li class="steps-segment">
                ...
                <div class="steps-content">
                    <p class="is-size-5">Cuidados pós-intubação</p>
                    <p>Reavaliação clínica periódica, imagem para confirmação de intubação não-seletiva.</p>
                </div>
            </li>
        </ul>
    </div>
